...
from .views import HomePageView, WorkorderListView, WorkorderDetailView, LogDetailView, LogCreateView
...
urlpatterns = [
    ...
    path("log/new/<int:workorder_pk>/",LogCreateView.as_view(),name="log_new",),
]